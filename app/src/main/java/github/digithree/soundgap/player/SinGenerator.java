...
//https://github.com/dingjikerbo/SinVoice/blob/master/app/src/main/java/com/libra/sinvoice/SinGenerator.java
...
public class SinGenerator {
    ...
    public void gen(int genRate, int duration) {
        if (STATE_START == mState) {
            ...
            int n = mBits / 2; // 波幅
            int totalCount = (mDuration * mSampleRate) / 1000; // duration内的总周期数
