...
//https://github.com/dingjikerbo/SinVoice/blob/master/app/src/main/java/com/libra/sinvoice/Buffer.java
...
public class Buffer {
    ...
    public void reset() {
        ...
        Log.d(TAG, "reset ProducerQueue Size:" + mProducerQueue.size() + "    ConsumeQueue Size:" + mConsumeQueue.size());
    }
